...
function qa(a,b){a.j={Wa:b,Ya:!0};a.h=a.m||a.A}
...
function sa(a){a.m=0;var b=a.j.Wa;a.j=null;return b}
function ta(a){a.C=[a.j];a.m=0;a.A=0}
function ua(a){var b=a.C.splice(0)[0];(b=a.j=a.j||b)?b.Ya?a.h=a.m||a.A:void 0!=b.u&&a.A<b.u?(a.h=b.u,a.j=null):a.h=a.A:a.h=0}
...
function ya(a){for(;a.h.h;)try{var b=a.i(a.h);if(b)return a.h.o=!1,{value:b.value,done:!1}}catch(c){a.h.i=void 0,qa(a.h,c)}a.h.o=!1;if(a.h.j){b=a.h.j;a.h.j=null;if(b.Ya)throw b.Wa;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
...
function d(h,k){var l=k&&typeof k;"object"==l||"function"==l?f.has(k)?l=f.get(k):(l=""+ ++g,f.set(k,l)):l="p_"+k;var n=h.data_[l];if(n&&Aa(h.data_,l))for(h=0;h<n.length;h++){var q=n[h];if(k!==k&&q.key!==q.key||k===q.key)return{id:l,list:n,index:h,J:q}}return{id:l,list:n,index:-1,J:void 0}}
...
var f=new WeakMap;e.prototype.set=function(h,k){h=0===h?0:h;var l=d(this,h);l.list||(l.list=this.data_[l.id]=[]);l.J?l.J.value=k:(l.J={next:this.h,previous:this.h.previous,head:this.h,key:h,value:k},l.list.push(l.J),this.h.previous.next=l.J,this.h.previous=l.J,this.size++);return this};
e.prototype.delete=function(h){h=d(this,h);return h.J&&h.list?(h.list.splice(h.index,1),h.list.length||delete this.data_[h.id],h.J.previous.next=h.J.next,h.J.next.previous=h.J.previous,h.J.head=null,this.size--,!0):!1};
...
b.prototype.R=function(g){if(g===this)this.A(new TypeError("A Promise cannot resolve to itself"));else if(g instanceof b)this.fa(g);else{a:switch(typeof g){case "object":var h=null!=g;break a;case "function":h=!0;break a;default:h=!1}h?this.M(g):this.m(g)}};
b.prototype.M=function(g){var h=void 0;try{h=g.then}catch(k){this.A(k);return}"function"==typeof h?this.ga(h,g):this.m(g)};
b.prototype.A=function(g){this.B(2,g)};
b.prototype.m=function(g){this.B(1,g)};
b.prototype.B=function(g,h){if(0!=this.h)throw Error("Cannot settle("+g+", "+h+"): Promise already settled in state"+this.h);this.h=g;this.j=h;2===this.h&&this.S();this.C()};
b.prototype.S=function(){var g=this;e(function(){if(g.I()){var h=da.console;"undefined"!==typeof h&&h.error(g.j)}},1)};
...
var r=[],p=0;do r.push(void 0),p++,d(k.value).qa(q(r.length-1),n),k=h.next();while(!k.done)})};
return b});
...
function Ea(){}
function Fa(a){a.Ha=void 0;a.getInstance=function(){return a.Ha?a.Ha:a.Ha=new a}}
...
c.prototype=b.prototype;a.P=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.km=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
qb.prototype.V=!0;qb.prototype.U=function(){return this.h};
function sb(a){return new qb(rb,a)}
var rb={};sb("");var tb={};function ub(a){this.h=tb===tb?a:"";this.V=!0}
ub.prototype.U=function(){return this.h.toString()};
ub.prototype.toString=function(){return this.h.toString()};function vb(a,b){this.h=b===wb?a:""}
m=vb.prototype;m.V=!0;m.U=function(){return this.h.toString()};
m.Ga=!0;m.Ca=function(){return 1};
...
m=Hb.prototype;m.V=!0;m.U=function(){return this.h.toString()};
m.Ga=!0;m.Ca=function(){return 1};
...
;var Tb={};function Ub(a,b,c){this.h=c===Tb?a:"";this.i=b;this.V=this.Ga=!0}
Ub.prototype.Ca=function(){return this.i};
Ub.prototype.U=function(){return this.h.toString()};
Ub.prototype.toString=function(){return this.h.toString()};
function Vb(a,b){var c=pb();a=c?c.createHTML(a):a;return new Ub(a,b,Tb)}
;function Wb(a,b){b instanceof Hb||b instanceof Hb||(b="object"==typeof b&&b.V?b.U():String(b),Mb.test(b)||(b="about:invalid#zClosurez"),b=new Hb(b,Ib));a.href=Jb(b)}
...
function Sc(a,b){db(b,function(c,d){c&&"object"==typeof c&&c.V&&(c=c.U());"style"==d?a.style.cssText=c:"class"==d?a.className=c:"for"==d?a.htmlFor=c:Tc.hasOwnProperty(d)?a.setAttribute(Tc[d],c):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,c):a[d]=c})}
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var l,n;a();return{reset:a,update:c,digest:d,rb:function(){for(var q=d(),r="",p=0;p<q.length;p++)r+="0123456789ABCDEF".charAt(Math.floor(q[p]/16))+"0123456789ABCDEF".charAt(q[p]%16);return r}}}
...
m=nd.prototype;m.isEnabled=function(){if(!y.navigator.cookieEnabled)return!1;if(!this.isEmpty())return!0;this.set("TESTCOOKIESENABLED","1",{Ia:60});if("1"!==this.get("TESTCOOKIESENABLED"))return!1;this.remove("TESTCOOKIESENABLED");return!0};
m.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.rm;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.Ia}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);c=f?";domain="+f:"";g=g?";path="+g:"";d=d?";secure":"";h=0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString();this.h.cookie=a+"="+b+c+g+h+d+(null!=e?";samesite="+
e:"")};
...
m.remove=function(a,b,c){var d=void 0!==this.get(a);this.set(a,"",{Ia:0,path:b,domain:c});return d};
...
$d.prototype.N=function(){return this};function ae(a){if(a instanceof be||a instanceof ce||a instanceof de)return a;if("function"==typeof a.next)return new be(function(){return ee(a)});
if("function"==typeof a[Symbol.iterator])return new be(function(){return a[Symbol.iterator]()});
if("function"==typeof a.N)return new be(function(){return ee(a.N())});
...
be.prototype.N=function(){return new ce(this.j())};
...
m.keys=function(){return ae(this.N(!0)).i()};
m.values=function(){return ae(this.N(!1)).i()};
m.entries=function(){var a=this;return Kd(this.keys(),function(b){return[b,a.get(b)]})};
m.N=function(a){he(this);var b=0,c=this.ba,d=this,e=new $d;e.h=function(){if(c!=d.ba)throw Error("The map has changed since the iterator was created");if(b>=d.h.length)throw Zd;var f=d.h[b++];return a?f:d.i[f]};
...
this.i=a;a.defaultPrevented&&me.P.preventDefault.call(this)};
me.prototype.stopPropagation=function(){me.P.stopPropagation.call(this);this.i.stopPropagation?this.i.stopPropagation():this.i.cancelBubble=!0};
me.prototype.preventDefault=function(){me.P.preventDefault.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var oe="closure_listenable_"+(1E6*Math.random()|0);var pe=0;function qe(a,b,c,d,e){this.listener=a;this.h=null;this.src=b;this.type=c;this.capture=!!d;this.va=e;this.key=++pe;this.ka=this.oa=!1}
function re(a){a.ka=!0;a.listener=null;a.h=null;a.src=null;a.va=null}
...
;var ve="closure_lm_"+(1E6*Math.random()|0),we={},xe=0;function ye(a,b,c,d,e){if(d&&d.once)ze(a,b,c,d,e);else if(Array.isArray(b))for(var f=0;f<b.length;f++)ye(a,b[f],c,d,e);else c=Ae(c),a&&a[oe]?a.W(b,c,Ia(d)?!!d.capture:!!d,e):Be(a,b,c,!1,d,e)}
...
function He(a){if("number"!==typeof a&&a&&!a.ka){var b=a.src;if(b&&b[oe])ue(b.i,a);else{var c=a.type,d=a.h;b.removeEventListener?b.removeEventListener(c,d,a.capture):b.detachEvent?b.detachEvent(Ee(c),d):b.addListener&&b.removeListener&&b.removeListener(d);xe--;(c=Ce(b))?(ue(c,a),0==c.h&&(c.src=null,b[ve]=null)):re(a)}}}
...
return a[Ie]}
;function Je(){L.call(this);this.i=new se(this);this.M=this;this.o=null}
...
function Ke(a,b){var c=a.o;if(c){var d=[];for(var e=1;c;c=c.o)d.push(c),++e}a=a.M;c=b.type||b;"string"===typeof b?b=new ke(b,a):b instanceof ke?b.target=b.target||a:(e=b,b=new ke(c,a),nb(b,e));e=!0;if(d)for(var f=d.length-1;!b.j&&0<=f;f--){var g=b.h=d[f];e=Le(g,c,!0,b)&&e}b.j||(g=b.h=a,e=Le(g,c,!0,b)&&e,b.j||(e=Le(g,c,!1,b)&&e));if(d)for(f=0;!b.j&&f<d.length;f++)g=b.h=d[f],e=Le(g,c,!1,b)&&e}
Je.prototype.D=function(){Je.P.D.call(this);if(this.i){var a=this.i,b=0,c;for(c in a.listeners){for(var d=a.listeners[c],e=0;e<d.length;e++)++b,re(d[e]);delete a.listeners[c];a.h--}}this.o=null};
Je.prototype.W=function(a,b,c,d){return this.i.add(String(a),b,!1,c,d)};
...
m.D=function(){M.P.D.call(this);this.clear();this.l.length=0};function pf(a){this.h=a}
...
qf.prototype.set=function(a,b){qf.P.set.call(this,a,sf(b))};
qf.prototype.i=function(a){a=qf.P.get.call(this,a);if(void 0===a||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
...
C(tf,qf);tf.prototype.set=function(a,b,c){if(b=sf(b)){if(c){if(c<Date.now()){tf.prototype.remove.call(this,a);return}b.expiration=c}b.creation=Date.now()}tf.P.set.call(this,a,b)};
tf.prototype.i=function(a){var b=tf.P.i.call(this,a);if(b){var c=b.creation,d=b.expiration;if(d&&d<Date.now()||c&&c>Date.now())tf.prototype.remove.call(this,a);else return b}};function uf(){}
;function vf(){}
C(vf,uf);vf.prototype[Symbol.iterator]=function(){return ae(this.N(!0)).i()};
...
m.N=function(a){var b=0,c=this.h,d=new $d;d.h=function(){if(b>=c.length)throw Zd;var e=c.key(b++);if(a)return e;e=c.getItem(e);if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
...
m.N=function(a){var b=0,c=this.h.XMLDocument.documentElement.attributes,d=new $d;d.h=function(){if(b>=c.length)throw Zd;var e=c[b++];if(a)return decodeURIComponent(e.nodeName.replace(/\./g,"%")).substr(1);e=e.nodeValue;if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
d.next=d.h.bind(d);return d};
...
Df.prototype.N=function(a){var b=this.i.N(!0),c=this,d=new $d;d.h=function(){for(var e=b.h();e.substr(0,c.h.length)!=c.h;)e=b.h();return a?e.substr(c.h.length):c.i.get(e)};
...
;function eg(a){this.C=a;this.i=null;this.m=0;this.B=null;this.o=0;this.j=[];for(a=0;4>a;a++)this.j.push(0);this.l=0;this.M=$f(window,"mousemove",Pa(this.R,this));a=Pa(this.I,this);"function"===typeof a&&(a=Lf(a));this.S=window.setInterval(a,25)}
C(eg,L);eg.prototype.R=function(a){void 0===a.h&&Wf(a);var b=a.h;void 0===a.i&&Wf(a);this.i=new Pc(b,a.i)};
...
eg.prototype.D=function(){window.clearInterval(this.S);ag(this.M)};function fg(){}
...
function ng(a){var b=void 0===a?{}:a;a=void 0===b.Ib?!1:b.Ib;b=void 0===b.tb?!0:b.tb;if(null==B("_lact",window)){var c=parseInt(E("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;z("_lact",c,window);z("_fact",c,window);-1==c&&og();$f(document,"keydown",og);$f(document,"keyup",og);$f(document,"mousedown",og);$f(document,"mouseup",og);a?$f(window,"touchmove",function(){pg("touchmove",200)},{passive:!0}):($f(window,"resize",function(){pg("resize",200)}),b&&$f(window,"scroll",function(){pg("scroll",200)}));
...
;var Yg={},Zg=0;
function $g(a,b,c,d,e){e=void 0===e?"":e;if(a)if(c&&!Xg("cobalt")){if(a){a instanceof Hb||(a="object"==typeof a&&a.V?a.U():String(a),Mb.test(a)?a=new Hb(a,Ib):(a=String(a),a=a.replace(/(%0A|%0D)/g,""),a=(b=a.match(Lb))&&Kb.test(b[1])?new Hb(a,Ib):null));b=Jb(a||Nb);if("about:invalid#zClosurez"===b||b.startsWith("data"))a="";else{if(b instanceof Ub)a=b;else{var f="object"==typeof b;a=null;f&&b.Ga&&(a=b.Ca());b=f&&b.V?b.U():String(b);Gb.test(b)&&(-1!=b.indexOf("&")&&(b=b.replace(Ab,"&amp;")),-1!=b.indexOf("<")&&
...
function Bh(a,b){if("log_event"===a.endpoint){var c="";a.sa?c="visitorOnlyApprovedKey":a.cttAuthInfo&&(wh[a.cttAuthInfo.token]=yh(a.cttAuthInfo),c=a.cttAuthInfo.token);var d=new Map;d.set(c,[a.payload]);b&&(qh=new b);return new Ve(function(e){qh&&qh.isReady()?Ch(d,e,{bypassNetworkless:!0}):e()})}}
...
;function Lh(a,b,c,d,e){od.set(""+a,b,{Ia:c,path:"/",domain:void 0===d?"youtube.com":d,secure:void 0===e?!1:e})}
...
function Eh(){return{innertubeApiKey:E("INNERTUBE_API_KEY",void 0),innertubeApiVersion:E("INNERTUBE_API_VERSION",void 0),wb:E("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),xb:E("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:E("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),zb:E("INNERTUBE_CONTEXT_HL",void 0),yb:E("INNERTUBE_CONTEXT_GL",void 0),Ab:E("INNERTUBE_HOST_OVERRIDE",void 0)||"",Cb:!!E("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),Bb:!!E("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
...
d[f]&&c.push({key:f,value:String(e[f])});0<c.length&&(b.request={internalExperimentFlags:c});f=b.client.clientName;if("WEB"===f||"MWEB"===f||1===f||2===f){if(!O("web_include_display_mode_killswitch")){var g;b.client.mainAppWebInfo=null!=(g=b.client.mainAppWebInfo)?g:{};b.client.mainAppWebInfo.webDisplayMode=Kh()}}else if(g=b.client.clientName,("WEB_REMIX"===g||76===g)&&!O("music_web_display_mode_killswitch")){var h;b.client.bb=null!=(h=b.client.bb)?h:{};b.client.bb.webDisplayMode=Kh()}a.appInstallData&&
...
function Vh(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||E("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.jm||E("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().im:b=sd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=E("SESSION_INDEX",0),O("pageid_as_header_web")&&(d["X-Goog-PageId"]=E("DELEGATED_SESSION_ID")));return d}
...
v(Q,wi);function Hi(a){Q.call(this,"MISSING_OBJECT_STORE",{Eb:a},Ci.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,Hi.prototype)}
...
{objectStoreNames:c,
dbName:b});if("AbortError"===e.name)return new Q("UNKNOWN_ABORT",{objectStoreNames:c,dbName:b},e.message);e.args=[{name:"IdbError",om:e.name,dbName:b,objectStoreNames:c}];e.level="WARNING";return e}
...
S.all=function(a){return new S(new Oi(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={ea:0};f.ea<a.length;f={ea:f.ea},++f.ea)Pi(S.resolve(a[f.ea]).then(function(g){return function(h){d[g.ea]=h;e--;0===e&&b(d)}}(f)),function(g){c(g)})}))};
...
m=Xi.prototype;m.add=function(a,b,c){return Yi(this,[a],{mode:"readwrite",K:!0},function(d){return d.objectStore(a).add(b,c)})};
m.clear=function(a){return Yi(this,[a],{mode:"readwrite",K:!0},function(b){return b.objectStore(a).clear()})};
m.close=function(){var a;this.h.close();(null===(a=this.options)||void 0===a?0:a.closed)&&this.options.closed()};
m.count=function(a,b){return Yi(this,[a],{mode:"readonly",K:!0},function(c){return c.objectStore(a).count(b)})};
function Zi(a,b,c){a=a.h.createObjectStore(b,c);return new $i(a)}
m.delete=function(a,b){return Yi(this,[a],{mode:"readwrite",K:!0},function(c){return c.objectStore(a).delete(b)})};
m.get=function(a,b){return Yi(this,[a],{mode:"readonly",K:!0},function(c){return c.objectStore(a).get(b)})};
function aj(a,b){return Yi(a,["LogsRequestsStore"],{mode:"readwrite",K:!0},function(c){c=c.objectStore("LogsRequestsStore");return Vi(c.h.put(b,void 0))})}
m.objectStoreNames=function(){return Array.from(this.h.objectStoreNames)};
function Yi(a,b,c,d){return H(a,function f(){var g=this,h,k,l,n,q,r,p,A,I,G,R,V;return x(f,function(K){switch(K.h){case 1:var U={mode:"readonly",K:!1,tag:"IDB_TRANSACTION_TAG_UNKNOWN"};"string"===typeof c?U.mode=c:Object.assign(U,c);h=U;g.transactionCount++;k=h.K?3:1;l=0;case 2:if(n){K.u(3);break}l++;q=Math.round(P());ra(K,4);r=g.h.transaction(b,h.mode);U=new bj(r);U=cj(U,d);return w(K,U,6);case 6:return p=K.i,A=Math.round(P()),dj(g,q,A,l,void 0,b.join(),h),K.return(p);case 4:I=sa(K);G=Math.round(P());
...
var g=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var h=c.blocked,k=c.blocking,l=c.Tb,n=c.upgrade,q=c.closed,r;g.addEventListener("upgradeneeded",function(p){try{if(null===p.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");p.dataLoss&&"none"!==p.dataLoss&&vi("IDB_DATA_CORRUPTED",{reason:p.dataLossMessage||"unknown reason",dbName:Ai(a)});var A=f(),I=new bj(g.transaction);
...
oj.prototype.open=function(){function a(){return H(c,function g(){var h=this,k,l,n,q,r;return x(g,function(p){switch(p.h){case 1:return ra(p,2),w(p,h.i(h.name,h.options.version,e),4);case 4:k=p.i;a:{var A=h.options;for(var I=u(Object.keys(A.wa)),G=I.next();!G.done;G=I.next()){G=G.value;var R=A.wa[G],V=void 0===R.Kb?Number.MAX_VALUE:R.Kb;if(k.h.version>=R.Ba&&!(k.h.version>=V)&&!k.h.objectStoreNames.contains(G)){A=G;break a}}A=void 0}l=A;if(void 0===l){p.u(5);break}if(h.j){p.u(6);break}h.j=!0;return w(p,
h.delete(),7);case 7:return ui(new Q("DB_DELETED_BY_MISSING_OBJECT_STORE",{dbName:h.name,Eb:l})),p.return(a());case 6:throw new Hi(l);case 5:return p.return(k);case 2:n=sa(p);if(n instanceof DOMException?"VersionError"!==n.name:"DOMError"in self&&n instanceof DOMError?"VersionError"!==n.name:!(n instanceof Object&&"message"in n)||"An attempt was made to open a database using a lower version than the existing version."!==n.message){p.u(8);break}return w(p,h.i(h.name,void 0,Object.assign(Object.assign({},
...
closed:b,Tb:b,upgrade:this.options.upgrade};return this.h=d=a()};var qj=new oj("YtIdbMeta",{wa:{databases:{Ba:1}},upgrade:function(a,b){b(1)&&Zi(a,"databases",{keyPath:"actualName"})}});
function rj(a){return H(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,qj.open(),2);d=e.i;return e.return(Yi(d,["databases"],{K:!0,mode:"readwrite"},function(f){var g=f.objectStore("databases");return g.get(a.actualName).then(function(h){if(h?a.actualName!==h.actualName||a.publicName!==h.publicName||a.userIdentifier!==h.userIdentifier:1)return Vi(g.h.put(a,void 0)).then(function(){})})}))})})}
...
function tj(a){return H(this,function c(){var d,e;return x(c,function(f){return 1==f.h?(d=[],w(f,qj.open(),2)):3!=f.h?(e=f.i,w(f,Yi(e,["databases"],{K:!0,mode:"readonly"},function(g){d.length=0;return gj(g.objectStore("databases"),{},function(h){a(h.getValue())&&d.push(h.getValue());return h.continue()})}),3)):f.return(d)})})}
...
;var ck=Rf("network_polling_interval",3E4);function T(){Je.call(this);this.C=0;this.I=this.l=!1;this.j=this.Fa();dk(this);ek(this)}
...
m.Y=function(a,b){a!==this.j&&((void 0===b?0:b)?this.O():this.j=a)};
m.Fb=function(a){this.l=!0;if(void 0===a?0:a)this.C||gk(this)};
m.Fa=function(){var a=window.navigator.onLine;return void 0===a?!0:a};
m.sb=function(){this.I=!0};
m.W=function(a,b){return Je.prototype.W.call(this,a,b)};
function ek(a){window.addEventListener("online",function(){return H(a,function c(){var d=this;return x(c,function(e){if(1==e.h)return w(e,d.O(),2);if(d.I&&O("offline_error_handling")){var f=ak().get("errors",!0);if(f){for(var g in f)if(f[g]){var h=new wi(g,"sent via offline_errors");h.name=f[g].name;h.stack=f[g].stack;h.level=f[g].level;Mf(h)}ak().set("errors",{},2592E3,!0)}}e.h=0})})})}
function dk(a){window.addEventListener("offline",function(){return H(a,function c(){var d=this;return x(c,function(e){return w(e,d.O(),0)})})})}
function gk(a){a.C=gg(function(){return H(a,function c(){var d=this;return x(c,function(e){if(1==e.h)return d.j?d.Fa()||!d.l?e.u(3):w(e,d.O(),3):w(e,d.O(),3);gk(d);e.h=0})})},ck)}
...
T.prototype.sendNetworkCheckRequest=T.prototype.O;T.prototype.listen=T.prototype.W;T.prototype.enableErrorFlushing=T.prototype.sb;T.prototype.getWindowStatus=T.prototype.Fa;T.prototype.monitorNetworkStatusChange=T.prototype.Fb;T.prototype.networkStatusHint=T.prototype.Y;T.prototype.isNetworkAvailable=T.prototype.G;T.getInstance=fk;function hk(a){a=void 0===a?{}:a;Je.call(this);var b=this;this.l=this.B=0;this.j=fk();var c=B("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.j);c&&c(a.Va);a.ab&&(c=B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.j))&&c();if(c=B("yt.networkStatusManager.instance.listen").bind(this.j))a.ya?(this.ya=a.ya,c("ytnetworkstatus-online",function(){ik(b,"publicytnetworkstatus-online")}),c("ytnetworkstatus-offline",function(){ik(b,"publicytnetworkstatus-offline")})):
...
hk.prototype.Y=function(a,b){b=void 0===b?!1:b;var c=B("yt.networkStatusManager.instance.networkStatusHint").bind(this.j);c&&c(a,b)};
hk.prototype.O=function(a){return H(this,function c(){var d=this,e;return x(c,function(f){return(e=B("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(d.j))?f.return(e(a)):f.return(!0)})})};
function ik(a,b){a.ya?a.l?(lg(a.B),a.B=ig(function(){a.m!==b&&(Ke(a,b),a.m=b,a.l=P())},a.ya-(P()-a.l))):(Ke(a,b),a.m=b,a.l=P()):Ke(a,b)}
...
function pk(){H(this,function b(){return x(b,function(c){switch(c.h){case 1:return w(c,zj(),2);case 2:kk=c.i;if(!kk||!xi()&&!O("nwl_init_require_datasync_id_killswitch")){c.u(0);break}jk=!0;ok.isNwlInitialized=jk;ok.databaseToken=kk;ok.isIdbSupported=!!kk;return w(c,Hj("LogsDatabaseV2"),4);case 4:if(!(.1>=Math.random())){c.u(5);break}return w(c,Tj(kk),6);case 6:return w(c,Xj(),5);case 5:qk();rk().G()&&sk();rk().W("publicytnetworkstatus-online",sk);rk().W("publicytnetworkstatus-offline",tk);if(!O("networkless_immediately_drop_sw_health_store")){c.u(8);
...
e.options.onSuccess=function(h,k){void 0!==e.id?Sj(e.id,d):f=!0;O("vss_network_hint")&&rk().Y(!0);g(h,k)};
...
a.options.onError=function(f,g){return H(b,function k(){return x(k,function(l){switch(l.h){case 1:if(!((B("ytNetworklessLoggingInitializationOptions")?ok.potentialEsfErrorCounter:mk)<=Rf("potential_esf_error_limit",10))){l.u(2);break}return w(l,rk().O(),3);case 3:if(rk().G())B("ytNetworklessLoggingInitializationOptions")&&ok.potentialEsfErrorCounter++,mk++;else return d(f,g),l.return();case 2:if(void 0===(null===a||void 0===a?void 0:a.id)){l.u(4);break}return 1>a.sendCount?w(l,Rj(a.id,c),8):w(l,Sj(a.id,
c),4);case 8:ig(function(){rk().G()&&sk()},5E3);
case 4:d(f,g),l.h=0}})})};
var e=a.options.onSuccess?a.options.onSuccess:function(){};
a.options.onSuccess=function(f,g){return H(b,function k(){return x(k,function(l){if(1==l.h)return void 0===(null===a||void 0===a?void 0:a.id)?l.u(2):w(l,Sj(a.id,c),2);O("vss_network_hint")&&rk().Y(!0);e(f,g);l.h=0})})};
return a}
...
function rk(){nk||(nk=new hk({ab:!0,Va:!0}));return nk}
...
this.ia=function(){};
this.now=Date.now;this.lb=null!==(b=a.lb)&&void 0!==b?b:100;this.jb=null!==(c=a.jb)&&void 0!==c?c:1;this.gb=null!==(d=a.gb)&&void 0!==d?d:2592E6;this.eb=null!==(e=a.eb)&&void 0!==e?e:12E4;this.ib=null!==(f=a.ib)&&void 0!==f?f:5E3;this.databaseToken=null!==(g=a.databaseToken)&&void 0!==g?g:void 0;this.ta=!!a.ta;this.ra=null!==(h=a.ra)&&void 0!==h?h:.1;this.Ma=null!==(k=a.Ma)&&void 0!==k?k:10;a.handleError&&(this.handleError=a.handleError);a.ia&&(this.ia=a.ia);this.L=a.L;this.Za=a.Za;this.F=a.F;this.H=
a.H;this.Z=a.Z;this.La=a.La;this.Ka=a.Ka;this.databaseToken&&(!this.L||this.L("networkless_logging"))&&Ek(this)}
function Ek(a){H(a,function c(){var d=this;return x(c,function(e){if(!d.databaseToken)return e.return();Fk(d);d.H.G()&&d.la();d.H.W(d.La,d.la.bind(d));d.H.W(d.Ka,d.Ra.bind(d));d.h=!0;return d.ta&&Math.random()<=d.ra?w(e,d.F.qb(d.databaseToken),0):e.u(0)})})}
...
Hk(c,e)})}else this.Z(a,b)};
m.sendThenWrite=function(a,b,c){var d=this;b=void 0===b?{}:b;if(this.databaseToken&&this.h){var e={url:a,options:b,timestamp:this.now(),status:"NEW",sendCount:0};this.L&&this.L("nwl_skip_retry")&&(e.skipRetry=c);if(this.H.G()){if(!e.skipRetry){var f=b.onError?b.onError:function(){};
...
f(g,h);r.h=0})})}}this.Z(a,b,e.skipRetry)}else this.F.set(e,this.databaseToken).catch(function(g){Hk(d,g)})}else this.Z(a,b,this.L&&this.L("nwl_skip_retry")&&c)};
...
d.options.onSuccess=function(g,h){void 0!==d.id?c.F.ha(d.id,c.databaseToken):e=!0;c.H.Y&&c.L&&c.L("vss_network_hint")&&c.H.Y(!0);f(g,h)};
this.Z(d.url,d.options);this.F.set(d,this.databaseToken).then(function(g){d.id=g;e&&c.F.ha(d.id,c.databaseToken)}).catch(function(g){Hk(c,g)})}else this.Z(a,b)};
m.la=function(){var a=this;if(!this.databaseToken)throw Li("throttleSend");this.i||(this.i=ig(function(){return H(a,function c(){var d=this,e;return x(c,function(f){if(1==f.h)return w(f,d.F.Xa("NEW",d.databaseToken),2);if(3!=f.h)return e=f.i,e?w(f,Gk(d,e),3):(d.Ra(),f.return());d.i&&(d.i=0,d.la());f.h=0})})},this.lb))};
m.Ra=function(){lg(this.i);this.i=0};
function Gk(a,b){return H(a,function d(){var e=this,f,g;return x(d,function(h){switch(h.h){case 1:if(!e.databaseToken)throw f=Li("immediateSend"),f;if(void 0===b.id){h.u(2);break}return w(h,e.F.Db(b.id,e.databaseToken),3);case 3:(g=h.i)?b=g:e.ia(Error("The request cannot be found in the database."));case 2:if(Ik(e,b,e.gb)){h.u(4);break}e.ia(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){h.u(5);break}return w(h,e.F.ha(b.id,e.databaseToken),5);case 5:return h.return();
case 4:b.skipRetry||(b=Jk(e,b));if(!b){h.u(0);break}if(!b.skipRetry||void 0===b.id){h.u(8);break}return w(h,e.F.ha(b.id,e.databaseToken),8);case 8:e.Z(b.url,b.options,!!b.skipRetry),h.h=0}})})}
function Jk(a,b){if(!a.databaseToken)throw Li("updateRequestHandlers");var c=b.options.onError?b.options.onError:function(){};
b.options.onError=function(e,f){return H(a,function h(){var k=this,l;return x(h,function(n){switch(n.h){case 1:l=k;if(!(k.potentialEsfErrorCounter<=k.Ma)){n.u(2);break}if(!k.H.O){n.u(3);break}return w(n,k.H.O(),3);case 3:if(k.H.G())k.potentialEsfErrorCounter++;else return c(e,f),n.return();case 2:if(void 0===(null===b||void 0===b?void 0:b.id)){n.u(5);break}return b.sendCount<k.jb?w(n,k.F.hb(b.id,k.databaseToken),9):w(n,k.F.ha(b.id,k.databaseToken),5);case 9:ig(function(){l.H.G()&&l.la()},k.ib);
case 5:c(e,f),n.h=0}})})};
var d=b.options.onSuccess?b.options.onSuccess:function(){};
b.options.onSuccess=function(e,f){return H(a,function h(){var k=this;return x(h,function(l){if(1==l.h)return void 0===(null===b||void 0===b?void 0:b.id)?l.u(2):w(l,k.F.ha(b.id,k.databaseToken),2);k.H.Y&&k.L&&k.L("vss_network_hint")&&k.H.Y(!0);d(e,f);l.h=0})})};
return b}
function Ik(a,b,c){b=b.timestamp;return a.now()-b>=c?!1:!0}
function Fk(a){if(!a.databaseToken)throw Li("retryQueuedRequests");a.F.Xa("QUEUED",a.databaseToken).then(function(b){b&&!Ik(a,b,a.eb)?ig(function(){return H(a,function d(){var e=this;return x(d,function(f){if(1==f.h)return void 0===b.id?f.u(2):w(f,e.F.hb(b.id,e.databaseToken),2);Fk(e);f.h=0})})}):a.H.G()&&a.la()})}
function Hk(a,b){a.mb&&!a.H.G()?a.mb(b):a.handleError(b)}
;function Kk(){Dk.call(this,{F:{qb:Tj,ha:Sj,Xa:Pj,Db:Qj,hb:Rj,set:Nj},H:new hk({ab:!0,Va:!0}),handleError:Mf,ia:Nf,Z:Lk,now:P,mb:bk,Za:kg(),La:"publicytnetworkstatus-online",Ka:"publicytnetworkstatus-offline",ta:O("enable_nwl_cleaning_logic"),ra:Rf("nwl_cleaning_rate",.1),Ma:Rf("potential_esf_error_limit",10),L:O});this.ta&&Math.random()<=this.ra&&this.databaseToken&&Xj();O("networkless_immediately_drop_sw_health_store")&&Mk(this);O("networkless_immediately_drop_all_requests")&&Uj();Hj("LogsDatabaseV2")}
...
c.onFetchSuccess=function(G,R){ai(p);I(G,R)}}try{r&&d.retry&&!d.cb.bypassNetworkless?(g.method="POST",d.cb.writeThenSend?O("use_new_nwl")?Nk().writeThenSend(q,g):vk(q,g):O("use_new_nwl")?Nk().sendAndWrite(q,g):Ak(q,g)):(g.method="POST",g.postParams||(g.postParams={}),Og(q,g))}catch(G){if("InvalidAccessError"==G.name)p&&(ai(p),p=0),Nf(Error("An extension is blocking network request."));
...
;var Qk=[{Ja:function(a){return"Cannot read property '"+a.key+"'"},
...
xa:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var Sk={X:[],T:[{Qa:Rk,weight:500}]};function Rk(a){a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function Tk(){this.T=[];this.X=[]}
var Uk;function Vk(){if(!Uk){var a=Uk=new Tk;a.X.length=0;a.T.length=0;Sk.X&&a.X.push.apply(a.X,Sk.X);Sk.T&&a.T.push.apply(a.T,Sk.T)}return Uk}
...
Vk();c=u(a.X);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.nm)){a=d.weight;break a}a=u(a.T);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Qa(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(Qk);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.xa[l.name])for(e=u(c.xa[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+e[g]]=
d[g+1];l.message=c.Ja(f);break}l.params||(l.params={});a=Vk();l.params["params.errorServiceSignature"]="msg="+a.X.length+"&cb="+a.T.length;l.params["params.serviceWorker"]="false";y.document&&y.document.querySelectorAll&&(l.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));sb("sample").constructor!==qb&&(l.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(l);if(0!==l.sampleWeight&&!bl.has(l.message)){"ERROR"===b?(Wk.ca("handleError",
l),O("record_app_crashed_web")&&0===el&&1===l.sampleWeight&&(el++,Pk("appCrashed",{appCrashType:"APP_CRASH_TYPE_BREAKPAD"})),dl++):"WARNING"===b&&Wk.ca("handleWarning",l);if(O("kevlar_gel_error_routing")){a=b;b:{c=u(gl);for(d=c.next();!d.done;d=c.next())if(Xg(d.value.toLowerCase())){c=!0;break b}c=!1}if(c)c=void 0;else{d={stackTrace:l.stack};l.fileName&&(d.filename=l.fileName);c=l.lineNumber&&l.lineNumber.split?l.lineNumber.split(":"):[];0!==c.length&&(1!==c.length||isNaN(Number(c[0]))?2!==c.length||
...
;var kl={Ic:3611,Vb:27686,Wb:85013,Xb:23462,Zb:42016,ac:62407,cc:26926,Yb:43781,dc:51236,ec:79148,fc:50160,hc:77504,uc:87907,wc:18630,xc:54445,yc:80935,zc:105675,Ac:37521,Bc:47786,Cc:98349,Dc:123695,Ec:6827,Fc:29434,Gc:7282,Hc:124448,Lc:32276,Kc:76278,Mc:93911,Nc:106531,Oc:27259,Pc:27262,Qc:27263,Sc:21759,Tc:27107,Uc:62936,Vc:49568,Wc:38408,Xc:80637,Yc:68727,Zc:68728,bd:80353,cd:80356,dd:74610,ed:45707,fd:83962,gd:83970,hd:46713,jd:89711,kd:74612,ld:93265,md:74611,nd:131380,pd:128979,qd:128978,od:131391,
rd:105350,td:134800,sd:131392,vd:113533,wd:93252,xd:99357,zd:94521,Ad:114252,Bd:113532,Cd:94522,yd:94583,Dd:88E3,Ed:93253,Fd:93254,Gd:94387,Hd:94388,Id:93255,Jd:97424,ud:72502,Kd:110111,Ld:76019,Nd:117092,Od:117093,Md:89431,Pd:110466,Qd:77240,Rd:60508,Sd:73393,Td:113534,Ud:92098,Vd:131381,Wd:84517,Xd:83759,Yd:80357,Zd:86113,ae:72598,be:72733,ce:107349,de:124275,ee:118203,ge:133275,he:133274,ie:133272,je:133273,ke:133276,me:117431,le:133797,ne:128572,oe:133405,pe:117429,qe:117430,re:117432,se:120080,
te:117259,ue:121692,we:132972,xe:133051,ye:133658,ze:132971,Ae:97615,Be:31402,De:133624,Ee:133623,Fe:133622,Ce:133621,Ge:84774,He:95117,Ie:98930,Je:98931,Ke:98932,Le:43347,Me:129889,Ne:45474,Oe:100352,Pe:84758,Qe:98443,Re:117985,Se:74613,Te:74614,Ue:64502,Ve:74615,We:74616,Xe:122224,Ye:74617,Ze:77820,af:74618,bf:93278,cf:93274,df:93275,ef:93276,ff:22110,gf:29433,hf:133798,jf:132295,lf:120541,nf:82047,pf:113550,qf:75836,rf:75837,sf:42352,tf:84512,uf:76065,vf:75989,wf:16623,xf:32594,yf:27240,zf:32633,
Af:74858,Cf:3945,Bf:16989,Df:45520,Ef:25488,Ff:25492,Gf:25494,Hf:55760,If:14057,Jf:18451,Kf:57204,Lf:57203,Mf:17897,Nf:57205,Of:18198,Pf:17898,Qf:17909,Rf:43980,Sf:46220,Tf:11721,Uf:49954,Vf:96369,Wf:3854,Xf:56251,Yf:25624,Zf:16906,ag:99999,cg:68172,dg:27068,eg:47973,fg:72773,gg:26970,hg:26971,ig:96805,jg:17752,kg:73233,lg:109512,mg:22256,ng:14115,og:22696,pg:89278,qg:89277,rg:109513,sg:43278,tg:43459,ug:43464,vg:89279,wg:43717,xg:55764,yg:22255,zg:89281,Ag:40963,Bg:43277,Cg:43442,Dg:91824,Eg:120137,
Fg:96367,Gg:36850,Hg:72694,Ig:37414,Jg:36851,Lg:124863,Kg:121343,Mg:73491,Ng:54473,Og:43375,Pg:46674,Qg:32473,Rg:72901,Sg:72906,Tg:50947,Ug:50612,Vg:50613,Wg:50942,Xg:84938,Yg:84943,Zg:84939,ah:84941,bh:84944,dh:84940,eh:84942,fh:35585,gh:51926,hh:79983,ih:63238,jh:18921,kh:63241,lh:57893,mh:41182,nh:33424,oh:22207,ph:42993,qh:36229,rh:22206,sh:22205,th:18993,uh:19001,vh:18990,wh:18991,xh:18997,yh:18725,zh:19003,Ah:36874,Bh:44763,Ch:33427,Dh:67793,Eh:22182,Fh:37091,Gh:34650,Hh:50617,Ih:47261,Jh:22287,
Kh:25144,Lh:97917,Mh:62397,Nh:125598,Oh:36961,Ph:108035,Qh:27426,Rh:27857,Sh:27846,Th:27854,Uh:69692,Vh:61411,Wh:39299,Xh:38696,Yh:62520,Zh:36382,ai:108701,bi:50663,ci:36387,di:14908,fi:37533,gi:105443,hi:61635,ii:62274,ji:133818,ki:65702,li:65703,mi:65701,ni:76256,oi:37671,ri:49953,ti:36216,vi:28237,wi:39553,xi:29222,yi:26107,zi:38050,Ai:26108,Ci:120745,Bi:26109,Di:26110,Ei:66881,Fi:28236,Gi:14586,Hi:57929,Ii:74723,Ji:44098,Ki:44099,Ni:23528,Oi:61699,Li:134104,Mi:134103,Pi:59149,Qi:101951,Ri:97346,
Si:118051,Ti:95102,Ui:64882,Vi:119505,Wi:63595,Xi:63349,Yi:95101,Zi:75240,aj:27039,bj:68823,cj:21537,dj:83464,ej:75707,fj:83113,gj:101952,hj:101953,jj:79610,kj:125755,lj:24402,mj:24400,nj:32925,oj:57173,pj:122502,qj:64423,rj:64424,sj:33986,tj:100828,uj:129089,vj:21409,wj:11070,xj:11074,yj:17880,zj:14001,Bj:30709,Cj:30707,Dj:30711,Ej:30710,Fj:30708,Aj:26984,Gj:63648,Hj:63649,Ij:51879,Jj:111059,Kj:5754,Lj:20445,Nj:130975,Mj:130976,Oj:110386,Pj:113746,Qj:66557,Rj:17310,Sj:28631,Tj:21589,Uj:68012,Vj:60480,
Wj:31571,Xj:76980,Yj:41577,Zj:45469,ak:38669,bk:13768,ck:13777,dk:62985,ek:4724,fk:59369,gk:43927,hk:43928,ik:12924,jk:100355,mk:56219,nk:27669,pk:10337,lk:47896,qk:122629,rk:121258,sk:107598,tk:127991,uk:96639,vk:107536,wk:130169,xk:96661,yk:96658,zk:116646,Ak:121122,Bk:96660,Ck:127738,Dk:127083,Ek:104443,Fk:96659,Gk:106442,Hk:134840,Ik:63667,Jk:63668,Kk:63669,Lk:130686,Mk:78314,Nk:55761,Ok:127098,Pk:134841,Qk:96368,Rk:67374,Sk:48992,Tk:49956,Uk:31961,Vk:26388,Wk:23811,Xk:5E4,Yk:126250,Zk:96370,
al:47355,bl:47356,dl:37935,fl:45521,il:21760,jl:83769,kl:49977,ll:49974,ml:93497,nl:93498,ol:34325,pl:115803,ql:123707,rl:100081,sl:35309,ul:68314,vl:25602,wl:100339,xl:59018,yl:18248,zl:50625,Al:9729,Bl:37168,Cl:37169,Dl:21667,El:16749,Fl:18635,Gl:39305,Hl:18046,Il:53969,Jl:8213,Kl:93926,Ll:102852,Ml:110099,Nl:22678,Ol:69076,Ql:100856,Rl:17736,Sl:3832,Tl:55759,Ul:64031,Vl:93044,Wl:93045,Xl:34388,Yl:17657,Zl:17655,am:39579,bm:39578,cm:77448,dm:8196,em:11357,fm:69877,gm:8197,hm:82039};function ll(){var a=kb(ml),b;return bf(new Ve(function(c,d){a.onSuccess=function(e){Ig(e)?c(new nl(e)):d(new ol("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
return a.join("")}
;var Dl,El=y.ytLoggingDocDocumentNonce_;El||(El=Cl(),Ra("ytLoggingDocDocumentNonce_",El));Dl=El;var Fl={kf:0,Jc:1,Rc:2,si:3,mf:4,Pl:5,ij:6,kk:7,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE"};function Gl(a){this.h=a}
...
d=u(d);for(e=d.next();!e.done;e=d.next())e=e.value.getAsJson(),(gb(e)||!e.trackingParams&&!e.veType)&&hl(Error("Child VE logged with no data"));d={cttAuthInfo:Pl(b),aa:b};"UNDEFINED_CSN"==b?Xl("visualElementAttached",c,d):a?Jh("visualElementAttached",c,a,d):Pk("visualElementAttached",c,d)}
...
Tm.prototype.clickCommand=function(a,b,c){a=a.clickTrackingParams;c=void 0===c?0:c;if(a)if(c=Nl(void 0===c?0:c)){var d=this.client;var e="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";a={csn:c,ve:Hl(a).getAsJson(),gestureType:e};b&&(a.clientData=b);b={cttAuthInfo:Pl(c),aa:c};"UNDEFINED_CSN"==c?Xl("visualElementGestured",a,b):d?Jh("visualElementGestured",a,d,b):Pk("visualElementGestured",a,b);b=!0}else b=!1;else b=!1;return b};
function Wm(a,b,c){c=void 0===c?{}:c;a.i.add(c.layer||0);a.j=function(){Xm(a,b,c);var f=Ll(c.layer);if(f){for(var g=u(a.A),h=g.next();!h.done;h=g.next())h=h.value,Vm(a,h[0],h[1]||f,c.layer);f=u(a.o);for(g=f.next();!g.done;g=f.next()){var k=g.value;g=void 0;g=void 0===g?0:g;h=Nl(g);var l=k[0]||Ll(g);h&&l&&(g=a.client,k=k[1],k={csn:h,ve:l.getAsJson(),clientData:k},l={cttAuthInfo:Pl(h),aa:h},"UNDEFINED_CSN"==h?Xl("visualElementStateChanged",k,l):g?Jh("visualElementStateChanged",k,g,l):Pk("visualElementStateChanged",
k,l))}}};
Nl(c.layer)||a.j();if(c.Ua)for(var d=u(c.Ua),e=d.next();!e.done;e=d.next())Um(a,e.value,c.layer);else il(Error("Delayed screen needs a data promise."))}
function Xm(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.Hb?c.Hb:c.layer;var e=Nl(d);d=Ll(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=E("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=a.client;h=f;var l=c.Ta,n=c.cttAuthInfo,q=Ul(),r={csn:q,pageVe:(new Gl({veType:b,youtubeData:g})).getAsJson()};h&&h.visualElement?r.implicitGesture=
{parentCsn:h.clientScreenNonce,gesturedVe:h.visualElement.getAsJson()}:h&&hl(new wi("newScreen() parent element does not have a VE - rootVe",b));l&&(r.cloneCsn=l);l={cttAuthInfo:n,aa:q};k?Jh("screenCreated",r,k,l):Pk("screenCreated",r,l);ii(li,new Rl(q));var p=q}catch(A){jl(A,{qm:b,rootVe:d,parentVisualElement:void 0,lm:e,pm:f,Ta:c.Ta});il(A);return}Ql(p,b,c.layer,c.cttAuthInfo);if((b=e&&"UNDEFINED_CSN"!==e&&d)&&!(b=O("screen_manager_skip_hide_killswitch"))){a:{b=u(Object.values(Fl));for(f=b.next();!f.done;f=
b.next())if(Nl(f.value)==e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,f=!0,k=(f=void 0===f?!1:f)?16:8,d={csn:e,ve:d.getAsJson(),eventType:k},f={cttAuthInfo:Pl(e),aa:e,ub:f},"UNDEFINED_CSN"==e?Xl("visualElementHidden",d,f):b?Jh("visualElementHidden",d,b,f):Pk("visualElementHidden",d,f));a.h[a.h.length-1]&&!a.h[a.h.length-1].csn&&(a.h[a.h.length-1].csn=p||"");Mm("csn",p);Yl.getInstance().clear();d=Ll(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(O("web_mark_root_visible")||O("music_web_mark_root_visible"))&&(e=
p,p={csn:e,ve:d.getAsJson(),eventType:1},b={cttAuthInfo:Pl(e),aa:e},"UNDEFINED_CSN"==e?Xl("visualElementShown",p,b):Pk("visualElementShown",p,b));a.i.delete(c.layer||0);a.j=void 0;e=u(a.B);for(p=e.next();!p.done;p=e.next())b=u(p.value),p=b.next().value,b=b.next().value,b.has(c.layer)&&d&&Vm(a,p,d,c.layer);for(c=0;c<a.l.length;c++){e=a.l[c];try{e()}catch(A){il(A)}}for(c=a.l.length=0;c<a.m.length;c++){e=a.m[c];try{e()}catch(A){il(A)}}}
...
Cn.prototype.D=function(){window.removeEventListener("message",this.B);L.prototype.D.call(this)};function Dn(){this.i=[];this.isReady=!1;this.j={};var a=this.h=new Cn(!!E("WIDGET_ID_ENFORCE")),b=this.Jb.bind(this);a.m=b;a.o=null;this.h.channel="widget";if(a=E("WIDGET_ID"))this.h.sessionId=a}
m=Dn.prototype;m.Jb=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.j[a]||"onReady"===a||(this.addEventListener(a,En(this,a)),this.j[a]=!0)):this.Oa(a,b,c)};
m.Oa=function(){};
function En(a,b){return function(c){return a.sendMessage(b,c)}}
m.addEventListener=function(){};
m.vb=function(){this.isReady=!0;this.sendMessage("initialDelivery",this.Ea());this.sendMessage("onReady");D(this.i,this.kb,this);this.i=[]};
m.Ea=function(){return null};
...
;function Jn(a){Dn.call(this);this.listeners=[];this.api=a;this.addEventListener("onReady",this.onReady.bind(this));this.addEventListener("onVideoProgress",this.Qb.bind(this));this.addEventListener("onVolumeChange",this.Rb.bind(this));this.addEventListener("onApiChange",this.Lb.bind(this));this.addEventListener("onPlaybackQualityChange",this.Nb.bind(this));this.addEventListener("onPlaybackRateChange",this.Ob.bind(this));this.addEventListener("onStateChange",this.Pb.bind(this));this.addEventListener("onWebglSettingsChanged",
this.Sb.bind(this))}
v(Jn,Dn);m=Jn.prototype;
m.Oa=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Gn(a)){var d=b;if(Ia(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=Hn(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
d[2];break b}d=null}e.videoId=d;e=Hn(e);break;case "loadPlaylist":case "cuePlaylist":e=In(d[0],d[1],d[2],d[3])}b.length=1;b[0]=e}this.api.handleExternalCall(a,b,c);Gn(a)&&Fn(this,this.Ea())}};
m.onReady=function(){var a=this.vb.bind(this);this.h.i=a};
m.addEventListener=function(a,b){this.listeners.push({eventType:a,listener:b});this.api.addEventListener(a,b)};
m.Ea=function(){if(!this.api)return null;var a=this.api.getApiInterface();ab(a,"getVideoData");for(var b={apiInterface:a},c=0,d=a.length;c<d;c++){var e=a[c];if(0===e.search("get")||0===e.search("is")){var f=0;0===e.search("get")?f=3:0===e.search("is")&&(f=2);f=e.charAt(f).toLowerCase()+e.substr(f+1);try{var g=this.api[e]();b[f]=g}catch(h){}}}b.videoData=this.api.getVideoData();b.currentTimeLastUpdated_=Date.now()/1E3;return b};
...
m.Nb=function(a){Fn(this,{playbackQuality:a})};
m.Ob=function(a){Fn(this,{playbackRate:a})};
...
m.Rb=function(){Fn(this,{muted:this.api.isMuted(),volume:this.api.getVolume()})};
...
m.Sb=function(){var a={sphericalProperties:this.api.getSphericalProperties()};Fn(this,a)};
m.dispose=function(){Dn.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function Kn(a){L.call(this);this.i={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.fb,this)}
v(Kn,L);m=Kn.prototype;m.start=function(){this.started||this.h||(this.started=!0,this.connection.da("RECEIVING"))};
m.da=function(a,b){this.started&&!this.h&&this.connection.da(a,b)};
m.fb=function(a,b,c){if(this.started&&!this.h){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&this.addListener(d.event);break;case "removeEventListener":"string"===typeof d.event&&this.removeListener(d.event);break;default:this.api.isReady()&&this.api.isExternalMethodAvailable(a,c||null)&&(b=Ln(a,b||{}),c=this.api.handleExternalCall(a,b,c||null),(c=Mn(a,c))&&this.da(a,c))}}};
m.addListener=function(a){if(!(a in this.i)){var b=this.Mb.bind(this,a);this.i[a]=b;this.addEventListener(a,b)}};
m.Mb=function(a,b){this.started&&!this.h&&this.connection.da(a,this.Da(a,b))};
m.Da=function(a,b){if(null!=b)return{value:b}};
m.removeListener=function(a){a in this.i&&(this.removeEventListener(a,this.i[a]),delete this.i[a])};
m.D=function(){var a=this.connection;a.h||nf(a.i,"command",this.fb,this);this.connection=null;for(var b in this.i)this.i.hasOwnProperty(b)&&this.removeListener(b);L.prototype.D.call(this)};function Nn(a,b){Kn.call(this,b);this.api=a;this.start()}
...
Nn.prototype.Da=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Kn.prototype.Da.call(this,a,b)};
...
On.prototype.l=function(a,b){this.h||this.i.ca.apply(this.i,arguments)};function Pn(a,b,c){On.call(this);this.j=a;this.destination=b;this.id=c}
v(Pn,On);Pn.prototype.da=function(a,b){this.h||this.j.da(this.destination,this.id,a,b)};
...
v(Qn,L);Qn.prototype.da=function(a,b,c,d){this.h||a!==this.destination||(a={id:b,command:c},d&&(a.data=d),this.destination.postMessage(Oe(a),this.origin))};
Qn.prototype.j=function(a){var b;if(b=!this.h)if(b=a.origin===this.origin)a:{b=this.destination;do{b:{var c=a.source;do{if(c===b){c=!0;break b}if(c===c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.connection,c.h||c.l("command",b.command,b.data,a.origin))}};
Qn.prototype.D=function(){ag(this.i);this.destination=null;L.prototype.D.call(this)};function Rn(){L.call(this);this.i=[]}
v(Rn,L);Rn.prototype.D=function(){for(;this.i.length;){var a=this.i.pop();a.target.removeEventListener(a.name,a.Qa,void 0)}L.prototype.D.call(this)};function Sn(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||kb(b);this.assets=a.assets||{};this.attrs=a.attrs||kb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
...
function Vn(a){var b=Wn(a),c=document.getElementById(b),d=c&&$m(c,"loaded");d||c&&!d||(c=Xn(a,b,function(){$m(c,"loaded")||(Ym(c),kh(b),cg(Qa(lh,b),0))}))}
...
function Wn(a){var b=Vc(document,"A");sb("This URL is never added to the DOM");Wb(b,new Hb(a,Ib));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+ac(a)}
;function Yn(a,b,c,d){L.call(this);var e=this;this.I=b;this.webPlayerContextConfig=d;this.za=!1;this.api={};this.ga=this.m=null;this.M=new M;this.i={};this.S=this.ma=this.elementId=this.Aa=this.config=null;this.R=!1;this.l=this.B=null;this.na={};this.nb=["onReady"];this.lastError=null;this.Pa=NaN;this.C={};this.ob=new Rn(this);this.fa=0;this.j=this.o=a;Ud(this,Qa(Sd,this.M));Zn(this);$n(this);Ud(this,Qa(Sd,this.ob));c?this.fa=cg(function(){e.loadNewVideoConfig(c)},0):d&&(ao(this),bo(this))}
v(Yn,L);m=Yn.prototype;m.getId=function(){return this.I};
m.loadNewVideoConfig=function(a){if(!this.h){this.fa&&(dg(this.fa),this.fa=0);var b=a||{};b instanceof Sn||(b=new Sn(b));this.config=b;this.setConfig(a);bo(this);this.isReady()&&co(this)}};
function ao(a){var b,c;a.webPlayerContextConfig?c=a.webPlayerContextConfig.rootElementId:c=a.config.attrs.id;a.elementId=c||a.elementId;"video-player"===a.elementId&&(a.elementId=a.I,a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.I:a.config.attrs.id=a.I);(null===(b=a.j)||void 0===b?void 0:b.id)===a.elementId&&(a.elementId+="-player",a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.elementId:a.config.attrs.id=a.elementId)}
m.setConfig=function(a){var b;this.Aa=a;this.config=eo(a);ao(this);this.ma||(this.ma=fo(this,(null===(b=this.config.args)||void 0===b?void 0:b.jsapicallback)||"onYouTubePlayerReady"));this.config.args?this.config.args.jsapicallback=null:this.config.args={jsapicallback:null};var c;if(null===(c=this.config)||void 0===c?0:c.attrs)a=this.config.attrs,(c=a.width)&&this.j&&(this.j.style.width=fd(Number(c)||c)),(a=a.height)&&this.j&&(this.j.style.height=fd(Number(a)||a))};
...
function bo(a){if(!a.h&&!a.R){var b=go(a);if(b&&"html5"===(ho(a)?"html5":null))a.S="html5",a.isReady()||jo(a);else if(ko(a),a.S="html5",b&&a.l&&a.o)a.o.appendChild(a.l),jo(a);else{a.config&&(a.config.loaded=!0);var c=!1;a.B=function(){c=!0;var d=lo(a,"player_bootstrap_method")?B("yt.player.Application.createAlternate")||B("yt.player.Application.create"):B("yt.player.Application.create");var e=a.config?eo(a.config):void 0;d&&d(a.o,e,a.webPlayerContextConfig);jo(a)};
a.R=!0;b?a.B():(dn(io(a),a.B),(b=mo(a))&&Un(b),no(a)&&!c&&z("yt.player.Application.create",null,void 0))}}}
function ho(a){var b=Rc(a.elementId);!b&&a.j&&a.j.querySelector&&(b=a.j.querySelector("#"+a.elementId));return b}
function jo(a){var b;if(!a.h){var c=ho(a),d=!1;c&&c.getApiInterface&&c.getApiInterface()&&(d=!0);d?(a.R=!1,!lo(a,"html5_remove_not_servable_check_killswitch")&&(null===c||void 0===c?0:c.isNotServable)&&a.config&&(null===c||void 0===c?0:c.isNotServable(null===(b=a.config.args)||void 0===b?void 0:b.video_id))||oo(a)):a.Pa=cg(function(){jo(a)},50)}}
function oo(a){Zn(a);a.za=!0;var b=ho(a);if(b){a.m=po(a,b,"addEventListener");a.ga=po(a,b,"removeEventListener");var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=a.api,e=0;e<c.length;e++){var f=c[e];d[f]||(d[f]=po(a,b,f))}}for(var g in a.i)a.i.hasOwnProperty(g)&&a.m&&a.m(g,a.i[g]);co(a);a.ma&&a.ma(a.api);a.M.ca("onReady",a.api)}
function po(a,b,c){var d=b[c];return function(e){for(var f=[],g=0;g<arguments.length;++g)f[g-0]=arguments[g];try{return a.lastError=null,d.apply(b,f)}catch(h){"sendAbandonmentPing"!==c&&(h.params=c,a.lastError=h,hl(h))}}}
function Zn(a){a.za=!1;if(a.ga)for(var b in a.i)a.i.hasOwnProperty(b)&&a.ga(b,a.i[b]);for(var c in a.C)a.C.hasOwnProperty(c)&&dg(Number(c));a.C={};a.m=null;a.ga=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
b.removeEventListener=function(e,f){a.removeEventListener(e,f)};
b.destroy=function(){a.dispose()};
b.getLastError=function(){return a.getLastError()};
b.getPlayerType=function(){return a.getPlayerType()};
b.getCurrentVideoConfig=function(){return a.Aa};
b.loadNewVideoConfig=function(e){a.loadNewVideoConfig(e)};
b.isReady=function(){return a.isReady()}}
m.isReady=function(){return this.za};
function $n(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){kh("WATCH_LATER_VIDEO_ADDED",b)});
...
m.addEventListener=function(a,b){var c=this,d=fo(this,b);d&&(0<=Wa(this.nb,a)||this.i[a]||(b=qo(this,a),this.m&&this.m(a,b)),this.M.subscribe(a,d),"onReady"===a&&this.isReady()&&cg(function(){d(c.api)},0))};
m.removeEventListener=function(a,b){this.h||(b=fo(this,b))&&nf(this.M,a,b)};
function fo(a,b){var c=b;if("string"===typeof b){if(a.na[b])return a.na[b];c=function(d){for(var e=[],f=0;f<arguments.length;++f)e[f-0]=arguments[f];if(f=B(b))try{f.apply(y,e)}catch(g){il(g)}};
a.na[b]=c}return c?c:null}
function qo(a,b){var c="ytPlayer"+b+a.I;a.i[b]=c;y[c]=function(d){var e=cg(function(){if(!a.h){a.M.ca(b,d);var f=a.C,g=String(e);g in f&&delete f[g]}},0);
hb(a.C,String(e))};
return c}
m.getPlayerType=function(){return this.S||(ho(this)?"html5":null)};
m.getLastError=function(){return this.lastError};
function ko(a){a.cancel();Zn(a);a.S=null;a.config&&(a.config.loaded=!1);var b=ho(a);b&&(go(a)||!no(a)?a.l=b:(b&&b.destroy&&b.destroy(),a.l=null));if(a.o)for(a=a.o;b=a.firstChild;)a.removeChild(b)}
m.cancel=function(){this.B&&kn(io(this),this.B);dg(this.Pa);this.R=!1};
m.D=function(){ko(this);if(this.l&&this.config&&this.l.destroy)try{this.l.destroy()}catch(b){il(b)}this.na=null;for(var a in this.i)this.i.hasOwnProperty(a)&&(y[this.i[a]]=null);this.Aa=this.config=this.api=null;delete this.o;delete this.j;L.prototype.D.call(this)};
...
function lo(a,b){var c;if(a.webPlayerContextConfig)var d=a.webPlayerContextConfig.serializedExperimentFlags;else if(null===(c=a.config)||void 0===c?0:c.args)d=a.config.args.fflags;return"true"===wg(d||"","&")[b]}
function eo(a){for(var b={},c=u(Object.keys(a)),d=c.next();!d.done;d=c.next()){d=d.value;var e=a[d];b[d]="object"===typeof e?kb(e):e}return b}
;var ro={},so="player_uid_"+(1E9*Math.random()>>>0);function to(a,b,c){var d="player";c=void 0===c?!0:c;d="string"===typeof d?Rc(d):d;var e=so+"_"+Ja(d),f=ro[e];if(f&&c)return uo(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new Yn(d,e,a,b);ro[e]=f;kh("player-added",f.api);Ud(f,function(){delete ro[f.getId()]});
return f.api}
...
;function zo(a,b,c){a="ST-"+ac(a).toString(36);b=b?fc(b):"";c=c||5;sl()&&Lh(a,b,c)}
;function Ao(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=E("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=E("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=dc(window.location.href);g&&f.push(g);g=dc(d);if(0<=Wa(f,g)||!g&&0==d.lastIndexOf("/",0))if(O("autoescape_tempdata_url")&&(f=document.createElement("a"),Wb(f,d),d=f.href),d){g=d.match(bc);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||b.ved)&&
(b=Object.assign({csn:Nl()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&zo(d,b,k)}else zo(d,b)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var n=void 0===n?"":n;var q=void 0===q?window:q;c=q.location;a=gc(a,l)+n;var r=void 0===r?ed:r;a:{r=void 0===r?ed:r;for(l=0;l<r.length;++l)if(n=r[l],n instanceof cd&&n.isValid(a)){r=new Lc(a,Jc);break a}r=void 0}c.href=Nc(r||Mc)}return!0}
...
l.serializedForcedExperimentIds||(g=Bg(),g.forced_experiments&&(l.serializedForcedExperimentIds=g.forced_experiments)),vo=to(a,l,!1)):vo=to(a);vo.addEventListener("onVideoDataChange",yo);a=E("POST_MESSAGE_ID","player");E("ENABLE_JS_API")?xo=new Jn(vo):E("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(wo=new Qn(window.parent,a,b),xo=new Nn(vo,wo.connection));nn();O("networkless_logging_web_embedded")&&(O("embeds_web_enable_new_nwl")?Nk():pk());O("embeds_enable_ua_ch_polyfill")&&Bn()},
void 0);
var Bo=Lf(function(){Om();var a=Nh.getInstance(),b=!!((Qh("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&Xd(document.body,"exp-invert-logo"))if(c&&!Xd(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!Xd(d,"inverted-hdpi")){var e=Vd(d);Wd(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&Xd(document.body,"inverted-hdpi")&&Yd();if(b!=c){b="f"+(Math.floor(119/31)+1);d=Qh(b)||0;d=c?d|67108864:
d&-67108865;0==d?delete Mh[b]:(c=d.toString(16),Mh[b]=c.toString());c=!0;O("web_secure_pref_cookie_killswitch")&&(c=!1);b=a.h;d=[];for(var f in Mh)d.push(f+"="+encodeURIComponent(String(Mh[f])));Lh(b,d.join("&"),63072E3,a.i,c)}Tm.h||(Tm.h=new Tm);a=Tm.h;f=16623;var g=void 0===g?{}:g;Object.values(kl).includes(f)||(hl(new wi("createClientScreen() called with a non-page VE",f)),f=83769);g.isHistoryNavigation||a.h.push({rootVe:f,key:g.key||""});a.A=[];a.o=[];g.Ua?Wm(a,f,g):Xm(a,f,g)}),Co=Lf(function(){vo&&
vo.sendAbandonmentPing&&vo.sendAbandonmentPing();
E("PL_ATT")&&tn.dispose();for(var a=0,b=ln.length;a<b;a++)lg(ln[a]);ln.length=0;jn("//static.doubleclick.net/instream/ad_status.js");mn=!1;N("DCLKSTAT",0);Td(xo,wo);vo&&(vo.removeEventListener("onVideoDataChange",yo),vo.destroy())});
window.addEventListener?(window.addEventListener("load",Bo),window.addEventListener("unload",Co)):window.attachEvent&&(window.attachEvent("onload",Bo),window.attachEvent("onunload",Co));Ra("yt.abuse.player.botguardInitialized",B("yt.abuse.player.botguardInitialized")||un);Ra("yt.abuse.player.invokeBotguard",B("yt.abuse.player.invokeBotguard")||vn);Ra("yt.abuse.dclkstatus.checkDclkStatus",B("yt.abuse.dclkstatus.checkDclkStatus")||on);
Ra("yt.player.exports.navigate",B("yt.player.exports.navigate")||Ao);Ra("yt.util.activity.init",B("yt.util.activity.init")||ng);Ra("yt.util.activity.getTimeSinceActive",B("yt.util.activity.getTimeSinceActive")||qg);Ra("yt.util.activity.setTimestamp",B("yt.util.activity.setTimestamp")||og);}).call(this);
